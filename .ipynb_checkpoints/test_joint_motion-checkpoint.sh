...
# 工作目录
WORK_DIR="./work_dir/uav2/test_joint_motion"

# 模型保存名称（可自定义）
# MODEL_SAVED_NAME="joint_model"

# 配置文件路径
CONFIG="./config/uav/test_joint_motion.yaml"
...
# 加载的权重
WEIGHTS="./work_dir/uav2/ctrgcn_motion_joint/runs-40-10240.pt"  # 指定预训练模型的权重文件路径
